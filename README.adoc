...
:url-repo: https://github.com/hyperpolymath/asdf-linkerd-plugin
...
image:https://img.shields.io/github/license/hyperpolymath/asdf-linkerd-plugin?style=flat-square[License,link=LICENSE]
image:https://img.shields.io/github/v/release/hyperpolymath/asdf-linkerd-plugin?style=flat-square[Release,link={url-repo}/releases]
image:https://img.shields.io/github/actions/workflow/status/hyperpolymath/asdf-linkerd-plugin/ci.yml?branch=main&style=flat-square[Build Status,link={url-repo}/actions]
image:https://img.shields.io/badge/asdf-plugin-blue?style=flat-square[asdf Plugin,link={url-asdf}]

[.lead]
An {url-asdf}[asdf] plugin to install and manage {url-tool}[Linkerd] versions.
...
Linkerd is an upstream tool managed by this plugin. Refer to the official
...
|**Version Switching**
|Switch between Linkerd versions per project

|**Project Isolation**
|Pin Linkerd per repository via `.tool-versions`

|**Reproducible Builds**
|Align CI/CD and developer environments to the same Linkerd version
...
=== Installing Linkerd Versions

[source,bash]
----
asdf list all linkerd
asdf install linkerd latest
asdf install linkerd 0.1.0
----
...
[source,bash]
----
asdf global linkerd 0.1.0
asdf local linkerd 0.1.0
asdf current linkerd
linkerd --version
----
...
* Ensure `linkerd` is on PATH after installation.
* Verify the installed version with `linkerd --version`.
